    ...
    public function getNewsItems()
    {
        ...
        if ($category = $this->getRequest()->getParam('category')) {
            ...
            if ($categoryId[0]['category_id']) {
                $collection->getSelect()->join('tbl_clnews_news_category', 'main_table.news_id = tbl_clnews_news_category.news_id','category_id');
                $collection->getSelect()->where('tbl_clnews_news_category.category_id =?', $categoryId[0]['category_id']);
            }
        } else {
