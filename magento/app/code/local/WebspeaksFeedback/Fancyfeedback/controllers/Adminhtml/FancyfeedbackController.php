...
$mail->setBodyHtml($body); //for sending message containing html code
		...
		$mail->setSubject($subject);
						Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('fancyfeedback')->__('mail= '.$mail->body));				
try {
			  if($mail->send())
			  {
				...
				// die("Mail sent successfully to $to");
									...
									Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('fancyfeedback')->__('error->'.$ex->getMessage()));		
