 ...
 */
class Den_Reviews_Block_Pager extends Mage_Core_Block_Template {
    ...
    public function getCollection() {
        ...
        if ($this->getCategoryMode()) {
            ...
            Mage::getSingleton('reviews/status')->addCatFilterToCollection($collection, $this->getCatId());
        }
    ...
    public function getPagesCount() {
        ...
        return ceil($this->getCollection()->count() / (int) Mage::getStoreConfig('reviews/reviews/perpage'));
    }
