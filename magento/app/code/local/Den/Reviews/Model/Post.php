...
class Den_Reviews_Model_Post extends Mage_Core_Model_Abstract{

    const NOROUTE_PAGE_ID = 'no-route';

    protected function _construct(){
        $this->_init('reviews/post');
    }
    ...
    public function getShortContent(){
        ...
        if(Mage::getStoreConfig(Den_Reviews_Helper_Config::XML_BLOG_PARSE_CMS)){
