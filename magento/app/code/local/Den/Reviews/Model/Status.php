...
class Den_Reviews_Model_Status extends Varien_Object{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('reviews')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('reviews')->__('Disabled'),
			self::STATUS_HIDDEN		=> Mage::helper('reviews')->__('Hidden')
        );
    }
}
