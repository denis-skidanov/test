 ...
 */
class Den_Faq_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(array('faq_faq_main' => $collection->getTable('faq/faq')), 'main_table.post_id=faq_faq_main.post_id', array('faq_faq_main.title'));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('comment', array(
            'header' => Mage::helper('faq')->__('Comment'),
            'align' => 'left',
            'index' => 'comment',
        ));
        ...
        $this->addColumn('email', array(
            'header' => Mage::helper('faq')->__('Email Address'),
            'width' => '150px',
            'index' => 'email',
        ));

        $this->addColumn('created_time', array(
            'header' => Mage::helper('faq')->__('Created'),
            'align' => 'center',
            'width' => '120px',
            'type' => 'date',
            'default' => '--',
        ...
        $this->addColumn('title', array(
            'header' => Mage::helper('faq')->__('Post Title'),
            'align' => 'left',
            'width' => '80px',
            'index' => 'title',
            'type' => 'text'
        ...
        $this->addColumn('faq_faq_main.post_id', array(
            'header' => Mage::helper('faq')->__('Link to Post'),
            'width' => '50px',
            'type' => 'action',
            'getter' => 'getPostId',
            'actions' => array(
                array(
                    'caption' => Mage::helper('faq')->__('View'),
                    'url' => array(
                        'base' => '*/manage_faq/edit'
                    ),
                    'field' => 'id'
                )
            ),
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    'caption' => Mage::helper('faq')->__('Approve'),
                    'url' => array('base' => '*/*/approve'),
                    'field' => 'id'
                ),
                array(
                    'caption' => Mage::helper('faq')->__('Unapprove'),
