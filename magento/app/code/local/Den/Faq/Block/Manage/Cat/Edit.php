...
class Den_Faq_Block_Manage_Cat_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('faq_data') && Mage::registry('faq_data')->getId() ) {
            return Mage::helper('faq')->__("Edit Category  '%s'", $this->htmlEscape(Mage::registry('faq_data')->getTitle()));
        } else {
