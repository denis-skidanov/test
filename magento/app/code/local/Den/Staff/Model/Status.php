...
class Den_Staff_Model_Status extends Varien_Object{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('staff')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('staff')->__('Disabled'),
			self::STATUS_HIDDEN		=> Mage::helper('staff')->__('Hidden')
        );
    }
}
