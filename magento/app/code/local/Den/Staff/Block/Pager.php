 ...
 */
class Den_Staff_Block_Pager extends Mage_Core_Block_Template {
    ...
    public function getCollection() {
        ...
        if ($this->getCategoryMode()) {
            ...
            Mage::getSingleton('staff/status')->addCatFilterToCollection($collection, $this->getCatId());
        }
    ...
    public function getPagesCount() {
        ...
        return ceil($this->getCollection()->count() / (int) Mage::getStoreConfig('staff/staff/perpage'));
    }
