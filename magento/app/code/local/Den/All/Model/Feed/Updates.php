...
class Den_All_Model_Feed_Updates extends Den_All_Model_Feed_Abstract
{
    ...
    {
        return Den_All_Helper_Config::UPDATES_FEED_URL;
    }
    ...
    public function isInteresting($item)
    {
        ...
        $isInterestedInSelfUpgrades = array_search(Den_All_Model_Source_Updates_Type::TYPE_INSTALLED_UPDATE, $types);
        ...
        foreach ($types as $type) {
            ...
            if (($type == Den_All_Model_Source_Updates_Type::TYPE_UPDATE_RELEASE) && $isInterestedInSelfUpgrades) {
                foreach ($exts as $ext) {
