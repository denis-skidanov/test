...
class Den_Partners_Helper_Post extends Mage_Core_Helper_Abstract {
	...
	public function renderPage(Mage_Core_Controller_Front_Action $action, $identifier=null) {
        ...
        $page = Mage::getModel('partners/post');
		...
		$page_title = Mage::getSingleton('partners/post')->load($identifier)->getTitle();
