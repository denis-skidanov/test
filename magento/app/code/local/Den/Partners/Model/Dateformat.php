...
class Den_Partners_Model_Dateformat{
    protected $_options;
    ...
    public function toOptionArray(){
        if (!$this->_options) {
			$this->_options[] = array(
			   ...
			   'label'=>Mage::helper('partners')->__('Full')
			);
			$this->_options[] = array(
			   'value'=>self::FORMAT_TYPE_LONG,
			   'label'=>Mage::helper('partners')->__('Long')
			);
			$this->_options[] = array(
			   'value'=>self::FORMAT_TYPE_MEDIUM,
			   'label'=>Mage::helper('partners')->__('Medium')
			);
			$this->_options[] = array(
			   'value'=>self::FORMAT_TYPE_SHORT,
			   'label'=>Mage::helper('partners')->__('Short')
			);
		}
