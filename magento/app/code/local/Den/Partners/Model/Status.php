...
class Den_Partners_Model_Status extends Varien_Object{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('partners')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('partners')->__('Disabled'),
			self::STATUS_HIDDEN		=> Mage::helper('partners')->__('Hidden')
        );
    }
}
