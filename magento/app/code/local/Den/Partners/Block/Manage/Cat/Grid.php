...
class Den_Partners_Block_Manage_Cat_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  {
      $collection = Mage::getModel('partners/cat')->getCollection();
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('sort_order', array(
          'header'    => Mage::helper('partners')->__('Sort Order'),
          'align'     => 'left',
		  'width'     => '50px',
          'index'     => 'sort_order',
      ));
