...
class Den_Partners_Block_Manage_Partners_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('identifier', array(
		  'header'    => Mage::helper('partners')->__('Identifier'),
		  'align'     => 'left',
		  'index'     => 'identifier',
		));
		...
		$this->addColumn('user', array(
         ...
         $this->addColumn('created_time',
                array(
                    'header' => Mage::helper('partners')->__('Created at'),
                    'index' => 'created_time',
                    'type' => 'datetime',
                    'width' => '120px',
                    'gmtoffset' => true,
         ...
         $this->addColumn('update_time',
                array(
                    'header' => Mage::helper('partners')->__('Updated at'),
                    'index' => 'update_time',
                    'width' => '120px',
                    'type' => 'datetime',
                    'gmtoffset' => true,
		...
		$this->addColumn('status', array(
		  ...
		  'type'      => 'options',
		  'options'   => array(
			  1 => Mage::helper('partners')->__('Enabled'),
			  2 => Mage::helper('partners')->__('Disabled'),
			  3 => Mage::helper('partners')->__('Hidden'),
		  ),
		));
		...
		$this->addColumn('action',
			array(
				...
				'actions'   => array(
					array(
						'caption'   => Mage::helper('partners')->__('Edit'),
						'url'       => array('base'=> '*/*/edit'),
						'field'     => 'id'
					)
				),
    ...
    protected function _prepareMassaction()
    {
        ...
        $statuses = Mage::getSingleton('partners/status')->getOptionArray();

        array_unshift($statuses, array('label'=>'', 'value'=>''));
        $this->getMassactionBlock()->addItem('status', array(
             'label'=> Mage::helper('partners')->__('Change status'),
