 ...
 */
class Den_Stock_Block_Cat extends Den_Stock_Block_Abstract {
     
    public function getPosts() {
        
        $cats = Mage::getSingleton('stock/cat');
    ...
    protected function _prepareLayout() {
        ...
        if (Mage::getStoreConfig('stock/stock/stockcrumbs') && ($breadcrumbs = $this->getLayout()->getBlock('breadcrumbs'))) {
            ...
            $breadcrumbs->addCrumb('stock_page', array('label' => $post->getTitle(), 'title' => $post->getTitle()));
        }
