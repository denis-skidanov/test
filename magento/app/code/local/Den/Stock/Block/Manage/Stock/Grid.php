...
class Den_Stock_Block_Manage_Stock_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('user', array(
         ...
         $this->addColumn('created_time',
                array(
                    'header' => Mage::helper('stock')->__('Created at'),
                    'index' => 'created_time',
                    'type' => 'datetime',
                    'width' => '120px',
                    'gmtoffset' => true,
         ...
         $this->addColumn('update_time',
                array(
                    'header' => Mage::helper('stock')->__('Updated at'),
                    'index' => 'update_time',
                    'width' => '120px',
                    'type' => 'datetime',
                    'gmtoffset' => true,
		...
		$this->addColumn('status', array(
		  ...
		  'type'      => 'options',
		  'options'   => array(
			  1 => Mage::helper('stock')->__('Enabled'),
			  2 => Mage::helper('stock')->__('Disabled'),
			  3 => Mage::helper('stock')->__('Hidden'),
		  ),
		));
