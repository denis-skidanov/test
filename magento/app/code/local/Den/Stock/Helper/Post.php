...
class Den_Stock_Helper_Post extends Mage_Core_Helper_Abstract {
	...
	public function renderPage(Mage_Core_Controller_Front_Action $action, $identifier=null) {
		...
		$page_title = Mage::getSingleton('stock/post')->load($identifier)->getTitle();
