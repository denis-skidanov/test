 ...
 */
class Den_Gloss_Block_Cat extends Den_Gloss_Block_Abstract {
     
    public function getPosts() {
        
        $cats = Mage::getSingleton('gloss/cat');
    ...
    protected function _prepareLayout() {
        ...
        if (Mage::getStoreConfig('gloss/gloss/glosscrumbs') && ($breadcrumbs = $this->getLayout()->getBlock('breadcrumbs'))) {
            ...
            $breadcrumbs->addCrumb('gloss_page', array('label' => $post->getTitle(), 'title' => $post->getTitle()));
        }
