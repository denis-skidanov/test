 ...
 */
class Den_Gloss_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(array('gloss_gloss_main' => $collection->getTable('gloss/gloss')), 'main_table.post_id=gloss_gloss_main.post_id', array('gloss_gloss_main.title'));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('comment', array(
            'header' => Mage::helper('gloss')->__('Comment'),
            'align' => 'left',
            'index' => 'comment',
        ));
        ...
        $this->addColumn('email', array(
            'header' => Mage::helper('gloss')->__('Email Address'),
            'width' => '150px',
            'index' => 'email',
        ));
	 ...
	 $this->addColumn('tel', array(
        ...
        $this->addColumn('created_time', array(
            'header' => Mage::helper('gloss')->__('Created'),
            'align' => 'center',
            'width' => '120px',
            'type' => 'date',
            'default' => '--',
        ...
        $this->addColumn('title', array(
            'header' => Mage::helper('gloss')->__('Post Title'),
            'align' => 'left',
            'width' => '80px',
            'index' => 'title',
            'type' => 'text'
        ...
        $this->addColumn('gloss_gloss_main.post_id', array(
            'header' => Mage::helper('gloss')->__('Link to Post'),
            'width' => '50px',
            'type' => 'action',
            'getter' => 'getPostId',
            'actions' => array(
                array(
                    'caption' => Mage::helper('gloss')->__('View'),
                    'url' => array(
                        'base' => '*/manage_gloss/edit'
                    ),
                    'field' => 'id'
                )
            ),
        ...
        $this->addColumn('action', array(
            ...
            'actions' => array(
                array(
                    'caption' => Mage::helper('gloss')->__('Approve'),
                    'url' => array('base' => '*/*/approve'),
                    'field' => 'id'
                ),
                array(
                    'caption' => Mage::helper('gloss')->__('Unapprove'),
