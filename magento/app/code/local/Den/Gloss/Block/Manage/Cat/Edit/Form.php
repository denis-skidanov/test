...
class Den_Gloss_Block_Manage_Cat_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	protected function _prepareForm()
	{
		...
		$fieldset = $form->addFieldset('category_form', array('legend'=>Mage::helper('gloss')->__('Category Information')));
		...
		$fieldset->addField('sort_order', 'text', array(
		  'label'     => Mage::helper('gloss')->__('Sort Order'),
		  'name'      => 'sort_order',
		));
