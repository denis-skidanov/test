...
class Den_Gloss_Model_Dateformat{
    protected $_options;
    ...
    public function toOptionArray(){
        if (!$this->_options) {
			$this->_options[] = array(
			   ...
			   'label'=>Mage::helper('gloss')->__('Full')
			);
			$this->_options[] = array(
			   'value'=>self::FORMAT_TYPE_LONG,
			   'label'=>Mage::helper('gloss')->__('Long')
			);
			$this->_options[] = array(
			   'value'=>self::FORMAT_TYPE_MEDIUM,
			   'label'=>Mage::helper('gloss')->__('Medium')
			);
			$this->_options[] = array(
			   'value'=>self::FORMAT_TYPE_SHORT,
			   'label'=>Mage::helper('gloss')->__('Short')
			);
		}
