...
class Den_Job_Model_Status extends Varien_Object{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('job')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('job')->__('Disabled'),
			self::STATUS_HIDDEN		=> Mage::helper('job')->__('Hidden')
        );
    }
}
